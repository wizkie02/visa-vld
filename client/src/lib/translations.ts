...
const baseKeys = {
  ...
  checkDocumentsYouHave: "Check the documents you have but don't want to upload",
  selectVisaTypeFirst: "Please select a visa type first to see document requirements",
  loadingDocumentRequirements: "Loading document requirements...",
  errorLoadingRequirements: "Error loading document requirements",
  noDocumentRequirementsFound: "No document requirements found for this visa type",
